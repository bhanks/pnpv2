...
$(function(){
	pexetoContactForm.set("<?php echo get_bloginfo('template_directory').'/includes/send-email.php';?>", "<?php echo get_opt('_message_sent_text');?>", "<?php echo get_opt('_name_error');?>", "<?php echo get_opt('_email_error');?>", "<?php echo get_opt('_question_error');?>");
});
</script>
